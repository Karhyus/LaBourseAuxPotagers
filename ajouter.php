                    ...
                    <div class="section-title">AJOUTER UN PROJET</div>
                        <div class="text-container">
                            ...
                            <form id="inscriptionForm" data-toggle="validator" data-focus="false" method="post" action="forms/creercompte.php">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control-input" id="project_description" name="project_description" minlength="8" maxlength="100"required>
                                ...
                                <div class="form-group">
                                    <input type="date" class="form-control-input" id="goal" name="goal" required>
