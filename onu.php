...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#resume">NOTRE INNOVATION<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#objectif">LES OBJECTIFS DE DEVELOPPEMENT DURABLE</a>
                    </li>
            </ul>
    ...
    <div id="resume" class="basic-3">
        <div class="container">
            <div class="section-title"> NOTRE INNOVATION</div>
            <div class="row">
                <div class="col-lg-12">
